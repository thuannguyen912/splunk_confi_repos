...
from spacebridgeapp.udf.udf_subscriptions import create_search_from_data_source
...
async def process_subscribe_udf_datasource(request_context: RequestContext,
    ...
    refresh_interval = refresh_to_seconds(search_defn.refresh) if search_defn else None
...
async def lazy_load_subscription_search(request_context, input_tokens, search_key,
    ...
    if search_defn.base:
        ...
        refresh_interval = refresh_to_seconds(parent_search_defn.refresh) if parent_search_defn else None
