...
from spacebridgeapp.util.constants import ITSI, ITSI_GLASS_TABLE, SPACEBRIDGE_APP_NAME, KEY
...
async def to_dashboard_description(json_object, request_context=None, async_splunk_client=None, minimal=False):
    """
    ...
    if isinstance(json_object, dict):
        ...
        dashboard_id = helper.generate_dashboard_id(owner=user, app_name=ITSI_GLASS_TABLE, dashboard_name=dashboard_key)
